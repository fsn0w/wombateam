...
<div class="w-full text-center lg:mt-24"><a href="" class="btn1 mt-10 py-2 px-10 text-xl lg:py-6 lg:px-24 lg:text-5xl ">Mint a Wombat</a></div>
        </div>
</div>
...
<div class="mx-auto mt-20 container lg:mt-40">
        ...
        <div class="w-full text-center lg:mt-24"><a href="" class="btn1 mt-10 py-2 px-10 text-xl inactive lg:py-6 lg:px-24 lg:text-5xl">Got it,<br/> let’s mint a Wombat</a></div>
